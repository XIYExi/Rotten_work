...
export default function HomePage() {
  ...
  return(
    <div className='relative'>
      ...
      {/*搜索框*/}
      <SearchBarPage className='my-container mx-atuo mt-[80px] md:mt-[120px] lg:mt-[0px] z-[2] pl-[60px] lg:pl-[50px] 2xl::pl-[0px] lg:absolute lg:left-0 lg:right-0 lg:top-[100%] lg:translate-y-[-396px]'/>
    </div>
